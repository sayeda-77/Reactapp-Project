pipeline{
  ...
  stage('Build and Push Docker Image') {
    steps{
      ...
      sh './build.sh'
      // Log in to Docker Hub (private rrepository) using your 
      credentials withCredentials ([usernamePassword(credentialsId:'docker',usernameVariable: 'DOCKERHUB_USERNAME', passwordVariable: 'DOCKERHUB_PASSWORD')])
